...
?>
													<TD width="50%" valign=top align="center">	
														<TABLE width="100%" border=0 cellSpacing=0 cellPadding=0>
															...
															<tr>
															<TD align="left" ><img src="images/video_icon.png" border="0"><a HREF="index.php?name=video&file=readvideo&id=<?=$arr['video']['id'];?>" ><b><?php echo $arr['video']['topic'];?></a><?=NewsIcon(TIMESTAMP, $arr['video']['post_date'], "images/icon_new.gif");?></b>
															</td>
															</tr>
