<table class="iconframe" cellpadding="0" cellspacing="0" style="width: 100%;">
	<tbody>
		<tr>
			<td class="imageframe">
				<TABLE width="" style="width: 100%;" align=center cellSpacing=0 cellPadding=0 border=0>
					<?php
					
					$category = empty($_GET['category']) ? "2" : $_GET['category'];
										...
										<TABLE width="200" border=0 cellSpacing=0 cellPadding=0>
											...
											<tr>
												<TD align="center" >
													<div class="photo" >
														<?php
														if( $video['pic'] !== 'default.jpg' ){
															$thumb_youtube = $video['pic'];
														}else{
															$thumb_youtube = $video['pic'];
														}
														?>
														
														<a HREF="index.php?name=video2&file=readvideo&id=<?=$video['id'];?>" ><img src="<?=$thumb_youtube;?>"></a>
											...
											<tr >
												...
												?>
												<TD align="left" ><b>Added :</b> <?php echo $date;?></td>
											</tr>

											<tr >
												<TD align="left" ><b>Duration :</b> <?php echo "".$durationx."";?></td>
											</tr>
										</table>
									</td>
								</tr>
