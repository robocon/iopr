      ...
      <TBODY>
        <TR>
		  ...
		  &nbsp;&nbsp;<IMG SRC="images/menu/textmenu_video.gif" BORDER="0"><BR>
				...
				<TR>
					<TD>
					<A HREF="?name=video2"><IMG SRC="images/admin/open.gif"  BORDER="0" align="absmiddle"><b><font color="#0033FF" size="2"> <?=_VIDEO_MOD_MENU_MAIN;?></A> &nbsp;&nbsp;&nbsp;<? if($admin_user){?><A HREF="?name=admin&file=video2&op=video_add"><IMG SRC="images/admin/book.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_FILE;?></A>&nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_youtube2"><IMG SRC="images/admin/7_40.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_YOUTUBE;?> </A>  &nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_category2&op=videocat_add"><IMG SRC="images/admin/opendir.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_CAT;?></A><?}?></font></td></tr>
									<TR>
...
?>
				...
				<table border="0" cellpadding="0" cellspacing="1" width=740 align=center>
					<tr>
						<td>
				<?
				SplitPage($page,$totalpage,"?name=video2&category=".$category."");
				echo $ShowSumPages ;
				echo "<BR>";
				echo $ShowPages ;
				?>
