      ...
      <TBODY>
        <TR>
		  ...
		  &nbsp;&nbsp;<IMG SRC="images/menu/textmenu_video.gif" BORDER="0"><BR>
				...
				<TR>
					<TD>
					<A HREF="?name=video2"><IMG SRC="images/admin/open.gif"  BORDER="0" align="absmiddle"><b><font color="#0033FF" size="2"> <?=_VIDEO_MOD_MENU_MAIN;?></A> &nbsp;&nbsp;&nbsp;<?php if($admin_user){?><A HREF="?name=admin&file=video2&op=video_add"><IMG SRC="images/admin/book.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_FILE;?></A>&nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_youtube2"><IMG SRC="images/admin/7_40.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_YOUTUBE;?> </A>  &nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_category2&op=videocat_add"><IMG SRC="images/admin/opendir.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_CAT;?></A><?php }?></font></td></tr>
									<TR>
  ...
  color:green;
			...
			<script language='JavaScript'>
              ...
              <table width="740" align="center" align="left" border="0">
                <tr>
                <td height="50" bgcolor="#F8F8F8"><form name="formsearch" method="post" action="?name=video2&file=video_search">
                    <div align="left">
...
&nbsp;<b><img src="images/admin/opendir.gif" align="absmiddle"> <a href="?name=video2"><?=_FROM_SEARCH_ALL;?></a>
<?php if($admin_user){
			...
			<form name="categoty" method="post" enctype="multipart/form-data"><center>
                  <td bgcolor="#F8F8F8"><div align="left"> &nbsp;&nbsp;<strong><font color="#009933"><?=_FROM_SEARCH_CAT;?> :</font></strong>&nbsp;
                          <select name="category" onchange="if(options[selectedIndex].value){location = options[selectedIndex].value};  MM_jumpMenu('parent',this,0)">
                            <option value="?name=video2"><?=_FROM_SEARCH_CAT_ALL;?></option>
                            <?php 
$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
$res['category'] = $db->select_query("SELECT * FROM web_video_category2 ORDER BY sort  ");
while($arr['category'] = $db->fetch($res['category'])){
	echo "<option value=\"?name=video2&category=".$arr['category']['id']."\" ";
...
$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
$limit = 10 ;
$SUMPAGE = $db->num_rows("web_video2","id","".$SQLwhere."");
...
$res['video'] = $db->select_query("SELECT * FROM web_video2 ".$SQLwhere2." ORDER BY id DESC LIMIT $goto, $limit ");
$count=0;
...
?>
													<TD width="33%" valign=top align="center">	
														<TABLE width="100%" border=0 cellSpacing=0 cellPadding=0>
															...
															<tr>
															<TD align="left" ><img src="images/video_icon.png" border="0"> <b><?php echo $arr['video']['topic'];?></b>
															</td>
															</tr>
...
?>
				...
				<table border="0" cellpadding="0" cellspacing="1" width=740 align=center>
					<tr>
						<td>
				<?php 				SplitPage($page,$totalpage,"?name=video2&category=".$category."");
				echo $ShowSumPages ;
				echo "<BR>";
				echo $ShowPages ;
				?>
