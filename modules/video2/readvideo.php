            ...
            <TD width="740" vAlign=top >
                ...
                &nbsp;&nbsp;<IMG SRC="images/menu/textmenu_video.gif" BORDER="0"><br>
                    <TABLE width="740" align=center cellSpacing=2 cellPadding=2 border=0 class="tablex">
                        ...
                        $res['video'] = $db->select_query("SELECT * FROM web_video2 WHERE id='".$id."' ");
                        ...
                        if(!$arr['video']['id']){
                            ...
                            $db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
                            $q['Pageview'] = "UPDATE web_video2 SET pageview = pageview+1 WHERE id = '".$id."' ";
                                    ...
                                    <tr>
                                        <td bgcolor="#E2E2E2" valign="top" align="right"><?=_FORM_MOD_POSTDATE;?> </td><td bgcolor="#E2E2E2" valign="top">
                                            ...
                                            <?php if($admin_user){
                                                ...
                                                ?>
                                                <a href="?name=admin&file=video_youtube2&op=video_edit&id=<?php echo $arr['video']['id'];?>"><img src="images/admin/edit.gif" border="0" alt="<?=_FROM_IMG_EDIT;?>" ></a>
                                                ...
                                                <tr>
                                                    <tr>
                                                        <TD colspan=2><B><FONT COLOR="#990099">
                                                            ...
                                                            $db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
                                                            $res['cat_video'] = $db->select_query("SELECT * FROM web_video2 WHERE category='".$arr['category']['id']."' ORDER BY id DESC LIMIT 5 ");
                                                            ...
                                                            while($arr['cat_video'] = $db->fetch($res['cat_video'])){
                                                                ?>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="images/icon/suggest.gif" BORDER="0" ALIGN="absmiddle"> <B><A HREF="?name=video2&file=readvideo&id=<?=$arr['cat_video']['id'];?>" target="_blank"><?=$arr['cat_video']['topic'];?></A></B> <?= ThaiTimeConvert($arr['cat_video']['post_date'],"","");?><BR>
                                                                    <?php }
                                                                    $db->closedb ();
                                                                    ?>
                                                                </TD>
                                                        ...
                                                        <BR><BR>
                                                            ...
                                                            <?php if($arr['video']['enable_comment']){
                                                                ...
                                                                $db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
                                                                $limit = 10 ;
                                                                $SUMPAGE = $db->num_rows("web_video_comment2","video_id","video_id=' ".$arr['video']['id']." ' ");
                                                                ...
                                                                $res['comment'] = $db->select_query("SELECT * FROM web_video_comment2 WHERE video_id='".$arr['video']['id']."' ORDER BY id  LIMIT $goto, $limit ");
                                                                $count=1;
                                                                                                                                        ...
                                                                                                                                        <center>
                                                                                                                                            <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                                                                <tr>
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td >
                                                                                                                                                                ...
                                                                                                                                                                <td bgcolor="#F5F5F5"  width="100%" alt=""><B><FONT COLOR="#990000"><?=_FROM_COMMENT_NUM;?> <?=$count;?></FONT></B>
                                                                                                                                                                    <?php if($admin_user){echo " <A HREF=\"?name=video2&file=delete_comment&id=".$id."&comment=".$arr['comment']['id']."\"><IMG SRC=\"images/admin/trash.gif\" height=\"18\"  BORDER=\"0\" ALIGN=\"absmiddle\"></A>";};?>
                                                                                                                                                    ...
                                                                                                                                                    echo "<center>";
                                                                                                                                                    SplitPage($page,$totalpage,"?name=video2&file=readvideo&id=".$id."");
                                                                                                                                                    echo $ShowSumPages ;
                                                                                                                                                    echo "<BR>";
                                                                                                                                                    echo $ShowPages ;
                                                                                                                                                    echo "<BR>";
                                                                                                                                                                ...
                                                                                                                                                                <TD width="10" vAlign=top><IMG src="images/fader.gif" border=0></TD>
                                                                                                                                                                    <TD width="490" vAlign=top align=left><IMG src="images/topfader.gif" border=0><BR>
                                                                                                                                                                        <IMG SRC="images/menu/textmenu_comment.gif" BORDER="0" ><BR>
                                                                                                                                                                            <FORM NAME="form2" METHOD=POST ACTION="?name=video2&file=comment&id=<?=$id;?>">
