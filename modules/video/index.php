      ...
      <TBODY>
        <TR>
		  ...
		  &nbsp;&nbsp;<IMG SRC="images/menu/textmenu_video.gif" BORDER="0"><BR>
				...
				<TR>
					<TD>
					<A HREF="?name=video"><IMG SRC="images/admin/open.gif"  BORDER="0" align="absmiddle"><b><font color="#0033FF" size="2"> <?=_VIDEO_MOD_MENU_MAIN;?></A> &nbsp;&nbsp;&nbsp;<?php if($admin_user){?><A HREF="?name=admin&file=video&op=video_add"><IMG SRC="images/admin/book.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_FILE;?></A>&nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_youtube"><IMG SRC="images/admin/7_40.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_YOUTUBE;?> </A>  &nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=video_category&op=videocat_add"><IMG SRC="images/admin/opendir.gif"  BORDER="0" align="absmiddle"> <?=_VIDEO_MOD_MENU_ADD_CAT;?></A><?php }?></font></td></tr>
									<TR>
...
?>
													<TD width="33%" valign=top align="center">	
														<TABLE width="100%" border=0 cellSpacing=0 cellPadding=0>
															...
															<TD align="center" >
															<div class="photo" >
<a HREF="index.php?name=video&file=readvideo&id=<?=$arr['video']['id'];?>" ><span></span><img src="<?php if ($arr['video']['youtube']!=1){ if ($arr['video']['pic']){echo "video/thumbs/".$arr['video']['pic'].""; } else{ echo "images/video_blank.gif";} }else { echo "http://img.youtube.com/vi/".$arr['video']['video']."/default.jpg";}?>" width="<?=_IVIDEOT_W;?>" height="<?=_IVIDEOT_H;?>"></a>
...
?>
				...
				<table border="0" cellpadding="0" cellspacing="1" width=740 align=center>
					<tr>
						<td>
				<?php 				SplitPage($page,$totalpage,"?name=video&category=".$category."");
				echo $ShowSumPages ;
				echo "<BR>";
				echo $ShowPages ;
				?>
