...
<A HREF="?name=download"><IMG SRC="images/admin/open.gif"  BORDER="0" align="absmiddle"> <?=_DOWNLOAD_MOD_VIEW_TITLE;?></A> &nbsp;&nbsp;&nbsp;
<?php
if (!empty($admin_user) || !empty($login_true) ){
?>
<A HREF="?name=download&file=add&op=download_add"><IMG SRC="images/admin/book.gif"  BORDER="0" align="absmiddle"> <?=_DOWNLOAD_MOD_VIEW_ADD;?></A><BR>
<?php
}
?>
...
$db->closedb ();
// �к������ download �ͧ maxsite 1.10 �Ѳ����� www.narongrit.net
...
$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
$sql="select * From ".TB_DOWNLOAD." where $fields like '%$keyword%'";	//���͡�������� DB �ҡ���ҧ��Ǵ
