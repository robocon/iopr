...
?>
				...
				<TR>
					<TD ><b><?=_CAL_ACTIVIT_DETAIL;?> <?php if ($arr['events']['timeout']<>'') { echo "<font color=\"#CC0000\">( "._CAL_DATE_START." ".$arr['events']['timeout']." )</font>";}?></b>
					<BR>
...
?>
				  <a href="?name=admin&file=editevent&id=<?php echo $arr['events']['id'];?>"><img src="images/admin/edit.gif" border="0" alt="<?=_FROM_IMG_EDIT;?>" ></a> 
				  <a href="javascript:Confirm('?name=admin&file=delevent&id=<?php echo $arr['events']['id'];?>&op=calendar_del','<?php echo _FROM_COMFIRM_DEL;?>');"><img src="images/admin/trash.gif"  border="0" alt="<?=_FROM_IMG_DEL;?>" ></a>
<?php }
?>	
					</TD>
				</TR>
